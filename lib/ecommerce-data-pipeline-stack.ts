  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const glueJob = new glue.CfnJob(this, 'DataProcessingJob', {
      ...
      defaultArguments: {
        ...
        '--additional-python-modules': 'boto3>=1.34.0,requests,pandas>=1.5.0,numpy>=1.24.0',
        '--extra-py-files': `s3://${scriptsBucket.bucketName}/shared/,s3://${scriptsBucket.bucketName}/embedding/,s3://${scriptsBucket.bucketName}/processing/,s3://${scriptsBucket.bucketName}/storage/`,
      },
      maxRetries: 0,
      timeout: 60,
      glueVersion: '4.0',
